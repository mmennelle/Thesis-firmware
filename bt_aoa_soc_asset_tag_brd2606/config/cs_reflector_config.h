...
// Pinned to antenna 1 because the brd4198a initiator runs 1:1 PBR
// (preferred_peer_antenna=1). SWITCHING changes the phase reference on
// every sync packet and produces 100% RTL 0xb (INCORRECT_MEASUREMENT).
// AoA CTE direction-finding uses a separate antenna switch pattern and is
// unaffected by this setting.
#define CS_REFLECTOR_CS_SYNC_ANTENNA      CS_SYNC_ANTENNA_1
