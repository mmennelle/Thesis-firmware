...
elseif (WIN32)
  # Fallback for environments where 'slt where gcc-arm-none-eabi' is not on PATH.
  # Probe installed gcc-* packages and pick one that contains arm-none-eabi-gcc.
  file(GLOB _SLT_GCC_COMPILERS
       "${USER_DIR}/.silabs/slt/installs/conan/p/gcc-*/p/bin/arm-none-eabi-gcc${EXE_SUFFIX}")
  if (_SLT_GCC_COMPILERS)
    list(SORT _SLT_GCC_COMPILERS COMPARE NATURAL ORDER DESCENDING)
    list(GET _SLT_GCC_COMPILERS 0 _SELECTED_GCC_COMPILER)
    get_filename_component(_SELECTED_GCC_BINDIR "${_SELECTED_GCC_COMPILER}" DIRECTORY)
    set(TOOLCHAIN_DIR "${_SELECTED_GCC_BINDIR}/")
  else()
